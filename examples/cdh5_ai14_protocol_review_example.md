...
Input: Cdh5-CreER;Ai14 mouse induction and genotyping protocol.

Expected outputs:

1. `Review_Report.md`
   - Critical finding: embryonic stage definition ambiguous.
   - Critical finding: reporter recombination QC absent.
